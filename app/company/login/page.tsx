...
import { Eye, EyeOff, Loader2, Lock, Mail, ArrowLeft, Building2 } from "lucide-react";
...
function CompanyLoginContent() {
  ...
  const callbackUrl = searchParams.get("callbackUrl") ?? "/company/dashboard";
      ...
      <div className="relative z-10 w-full max-w-5xl bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden grid md:grid-cols-2">
        ...
        <div className="hidden md:flex flex-col justify-between bg-gradient-to-br from-[#004aad] via-[#003c8c] to-[#00b4d8] p-10 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6 my-auto py-8">
            ...
            <h2 className="font-montserrat text-3xl font-extrabold leading-tight">
              Post opportunities. Discover top student talent.
            </h2>
            <p className="text-sm text-white/80 leading-relaxed font-normal">
              Access your company dashboard to post job and internship opportunities, review student applications, and view professional profiles.
            </p>
            <div className="pt-4 border-t border-white/10 flex items-center gap-3">
              <div className="size-10 rounded-full bg-white/20 flex items-center justify-center font-bold text-sm">IA</div>
              <div>
                <p className="text-xs font-bold">InternAcademy Hiring Platform</p>
                <p className="text-[11px] text-white/70">Connect with Bengaluru&apos;s best students</p>
              </div>
            </div>
          </div>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full space-y-6">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-[#004aad] block mb-1">Company Portal</span>
              <h1 className="font-montserrat text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">
                Sign in to your company account
              </h1>
              <p className="text-sm text-slate-500 mt-1">
                Don&apos;t have an account?{" "}
                <Link href="/company/signup" className="font-semibold text-[#004aad] hover:underline">
            ...
            <p className="text-center text-xs text-slate-400 pt-2">
              ...
              <Link href="/login" className="font-semibold text-[#004aad] hover:underline">Student Sign In</Link>
            </p>
          </div>
        </div>
      </div>
